  ...
  <section style="padding-bottom:1.5rem;">
    ...
    <section class="btbinfo">
        ...
        <template v-if="viewopt">
          <template v-if="hbinfo.status == 2 || hbinfo.status == 3">
...
.btcType :''}}</p>
    ...
    <section class="asset" v-if="viewopt">
        <div class="wrap">
            <p>您的数字货币资产<span>价值约{{hbinfo.receiveRedbagDetailInfo ? hbinfo.receiveRedbagDetailInfo.mayPointPrice:'0'}}元</span></p>
    ...
    <img src="../assets/tishi.png" class="tishi" v-if="tishi" />
    <div class="opmask" v-if="tishi"></div>
        ...
        if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
          ...
          window.setTimeout(function() {
            ...
            window.setTimeout(function() {
                ...
                if (timeOutDateTime - loadDateTime < 2000) {
                    this.tishi = false;
                    window.location = "http://www.btchb.io/btc-file/apk/app_1.0_2018-02-08_release_v.apk";
                } else {
                    window.close();
                }
            },  50);
